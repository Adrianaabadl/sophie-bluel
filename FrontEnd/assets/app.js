...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const API_WORKS = "http://web-6z5du17st95d.up-de-fra1-k8s-1.apps.run-on-seenode.com/api/works";
    let works = [];
    ...
    addPhotoForm.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('http://web-6z5du17st95d.up-de-fra1-k8s-1.apps.run-on-seenode.com/api/works', {
            method: 'POST',
            headers: {
                Authorization: `Bearer ${token}`,
            },
